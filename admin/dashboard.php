...
// Fetch number of HODs
$hodQuery = "SELECT COUNT(*) AS hod_count 
             FROM user_details 
...
if ($hodResult->num_rows > 0) {
    $row = $hodResult->fetch_assoc();
    $hodCount = $row['hod_count'];
}
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card text-center">
                        <div class="card-body">
                            <h5 class="card-title">Number of HODs</h5>
                            <p class="card-text"><?= $hodCount ?></p>
                        </div>
                    </div>
                </div>
                <!-- Departments Count -->
