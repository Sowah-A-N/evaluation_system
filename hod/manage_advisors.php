...
<div class="container-scroller">
    ...
    <div class="main-panel">
        <div class="app-content">
            ...
            <!-- Button to Add  -->
            <button class="btn btn-primary" data-toggle="modal" data-target="#addHodModal">Add an Advisor</button>
...
$sql = "SELECT ud.user_details, ud.f_name, ud.l_name, ud.email, ud.username, d.dep_name, 
l.level_name FROM user_details ud JOIN advisor_levels al ON ud.user_details = al.advisor_id
 JOIN department d ON al.department_id = d.t_id JOIN level l ON al.level_id = l.t_id 
